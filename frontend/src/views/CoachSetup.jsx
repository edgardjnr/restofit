...
//
// Two answers. "Use my self-hosted RestoFit" hands the whole thing to the paired server — the
...
export default function CoachSetup() {
  ...
  const current = coachLocal?.mode === 'server' ? t('Runs on your RestoFit server')
  ...
  return <div className="narrow">
    ...
    <Section title={t('How should the Coach run?')} footer={current}>
      <Row icon="rocket" iconTint="var(--indigo)" title={t('Use my self-hosted RestoFit')}
