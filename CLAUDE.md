...
- O app usa **os GIFs e imagens originais do dataset** (hasaneyldrm/exercises-dataset, © Gym visual,
  ...
  Em 2026-09-26 voltaram o `0001` (3/4 sit-up), o `0002` (45° side bend) , o `0003` (air bike) e o `0006` (alternate heel touchers), gerados no **Kling**. Para fazer o próximo, use a
